...
# Let's make sure you know how to use GitHub. Create a GitHub account if you don't have one. Create a new public repository. Commit a single JSON file called email.json with the value {"email": "22f3000344@ds.study.iitm.ac.in"} and push it.
...
# GA2_3("""Publish a page using GitHub Pages that showcases your work. Ensure that your email address 22f3000344@ds.study.iitm.ac.in is in the page's HTML.

# GitHub pages are served via CloudFlare which obfuscates emails. So, wrap your email address inside a:

# <!--email_off-->22f3000344@ds.study.iitm.ac.in<!--/email_off-->
# What is the GitHub Pages URL? It might look like: https://[USER].github.io/[REPO]/""")

# GA2_7("""Create a GitHub action on one of your GitHub repositories. Make sure one of the steps in the action has a name that contains your email address 22f3000344@ds.study.iitm.ac.in. For example:

# jobs:
#   test:
#     steps:
#       - name: 22f3000344@ds.study.iitm.ac.in
...
# Include a step with your email 22f3000344@ds.study.iitm.ac.in in its name
